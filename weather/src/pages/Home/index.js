...
function Home() {
    ...
    useEffect(() => {
        ...
        const today =  weatherApir.current
        setUvi(today.uvi)
        setWind(today.wind_speed)
        setHumidity(today.humidity)
        setVisibility(today.visibility)
        setPressure(today.pressure)
    ...
    return (
        <div className={cx('row')}>
            <div className={cx('d-flex', 'flex-wrap' )}>
                <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>UV index</p>
                    <div className={cx('text-wrap','color-sun')}>
                        <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="text-warning icon-size my-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>
                        <p className={cx('fs-3 text-muted fw-bold')}>{uvi}</p>
                    </div>
                </div>
                <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>Wind Status</p>
                    <div className={cx('text-wrap', 'color-blue')}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" className="icon-color icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M1.48,21.1c0,0.24,0.09,0.44,0.27,0.6c0.17,0.17,0.37,0.25,0.61,0.25h5.88c0.26,0,0.48,0.09,0.68,0.28
                                ...
                                z"></path></svg>
                        <p className={cx('fs-3 text-muted fw-bold')}>{wind} km/h</p>
                    </div>
                </div>
                <div className={cx('item-box', 'bg-white')}>
                    <p className="fs-5 text-black-50">Sunrise &amp; Sunset</p>
                    <div className={cx('text-wrap','color-sun')}>
                       <div className={cx('bg-white' ,'p-2', 'rounded-3' ,'h-100')}><p className={cx('fs-4', 'text-muted', 'fw-bold', 'two-row')}><svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" className="text-warning icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2.75,15.36c0-0.25,0.1-0.48,0.3-0.69c0.22-0.19,0.46-0.29,0.7-0.29h2.33c0.27,0,0.49,0.1,0.67,0.29
                            ...
                            C23.08,15.88,22.99,15.64,22.99,15.36z"></path></svg>
                             5:14 am </p>
                            <p className={cx('fs-4', 'text-muted', 'fw-bold', 'two-row')}>
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" className="text-warning icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2.88,15.47c0-0.28,0.1-0.5,0.3-0.68c0.17-0.18,0.4-0.26,0.68-0.26h2.31c0.27,0,0.49,0.09,0.67,0.27
                ...
                <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>Humidity</p>
                    <div className={cx('text-wrap', 'color-blue')}>
                       <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" className="icon-color icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M7.56,17.19c0-0.88,0.24-1.89,0.72-3.03s1.1-2.25,1.86-3.31c1.56-2.06,2.92-3.62,4.06-4.67l0.75-0.72
                            ...
                            "></path></svg>
                        <p className={cx('fs-3 text-muted fw-bold')}>{humidity} %</p>
                    </div>
                </div>
                 <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>Visibility</p>
                    <div className={cx('text-wrap', 'color-sun')}>
                        ...
                        <p className={cx('fs-3 text-muted fw-bold')}>{visibility} km</p>
                    </div>
                </div>
                <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>Pressure</p>
                    <div className={cx('text-wrap', 'color-blue')}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 512" className="icon-color icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M192 384c0 35.346-28.654 64-64 64s-64-28.654-64-64c0-35.346 28.654-64 64-64s64 28.654 64 64zm32-84.653c19.912 22.563 32 52.194 32 84.653 0 70.696-57.303 128-128 128-.299 0-.609-.001-.909-.003C56.789 511.509-.357 453.636.002 383.333.166 351.135 12.225 321.755 32 299.347V96c0-53.019 42.981-96 96-96s96 42.981 96 96v203.347zM208 384c0-34.339-19.37-52.19-32-66.502V96c0-26.467-21.533-48-48-48S80 69.533 80 96v221.498c-12.732 14.428-31.825 32.1-31.999 66.08-.224 43.876 35.563 80.116 79.423 80.42L128 464c44.112 0 80-35.888 80-80z"></path></svg>
                        <p className={cx('fs-3 text-muted fw-bold')}>{pressure}</p>
                    </div>
                </div>
            </div>
        </div>
