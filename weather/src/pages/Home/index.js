...
function Home() {
    ...
    useEffect(() => {
        const fetProduct = async () => {
            ...
            console.log('api where',weatherApir);
        }
        fetProduct();
    }, [])
            ...
            <div className={cx('d-flex', 'flex-wrap' )}>
                <div className={cx('item-box', 'bg-white')}>
                    ...
                    <div className={cx('text-wrap','color-sun')}>
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="text-warning icon-size my-1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line><line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line></svg>
                        <p className={cx('fs-3 text-muted fw-bold')}>0</p>
                    </div>
                </div>
                <div className={cx('item-box', 'bg-white')}>
                    <p className={cx('fs-5','text-black-50')}>Wind Status</p>
                    <div className={cx('text-wrap', 'color-blue')}>
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" class="icon-color icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M1.48,21.1c0,0.24,0.09,0.44,0.27,0.6c0.17,0.17,0.37,0.25,0.61,0.25h5.88c0.26,0,0.48,0.09,0.68,0.28
                    ...
                    <div className={cx('text-wrap','color-sun')}>
                       <div className={cx('bg-white' ,'p-2', 'rounded-3' ,'h-100')}><p className={cx('fs-4', 'text-muted', 'fw-bold', 'two-row')}><svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" class="text-warning icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2.75,15.36c0-0.25,0.1-0.48,0.3-0.69c0.22-0.19,0.46-0.29,0.7-0.29h2.33c0.27,0,0.49,0.1,0.67,0.29
                            ...
                            <p className={cx('fs-4', 'text-muted', 'fw-bold', 'two-row')}>
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" class="text-warning icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M2.88,15.47c0-0.28,0.1-0.5,0.3-0.68c0.17-0.18,0.4-0.26,0.68-0.26h2.31c0.27,0,0.49,0.09,0.67,0.27
                ...
                <div className={cx('item-box', 'bg-white')}>
                    ...
                    <div className={cx('text-wrap', 'color-blue')}>
                       <svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 30 30" class="icon-color icon-size" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M7.56,17.19c0-0.88,0.24-1.89,0.72-3.03s1.1-2.25,1.86-3.31c1.56-2.06,2.92-3.62,4.06-4.67l0.75-0.72
